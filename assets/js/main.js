! function (e) {
    ...
    if (e(window).on("load", (function () {
        ...
        e(this).scrollTop() > 0 ? (e(".sticky-wrapper").addClass("sticky"), e(".category-menu").addClass("close-category")) : (e(".sticky-wrapper").removeClass("sticky"), e(".category-menu").removeClass("close-category"))
    ...
    e("[data-bg-src]").length > 0 && e("[data-bg-src]").each((function () {
        ...
        var t = e(this),
            ...
            c = {
                ...
                on: {
                    init: function () {
                        var a = this.el.querySelectorAll(".swiper-slide:not(.swiper-slide-duplicate)").length;
                        if (o && e(o).html('<span class="current-slide">01</span> <span class="total-slides">' + (a < 10 ? "0" + a : a) + "</span>"), t.find(".progress-number").length) {
                            const e = t.find(".progress-number span:first-child")[0],
                                s = t.find(".progress-number span:last-child")[0];
                            e && s && (e.textContent = 1, s.textContent = a)
                        }
                    },
                    slideChange: function () {
                        var a = this.realIndex + 1,
                            s = this.el.querySelectorAll(".swiper-slide:not(.swiper-slide-duplicate)").length;
                        if (o && e(o).html('<span class="current-slide">' + (a < 10 ? "0" + a : a) + '</span> <span class="total-slides">' + (s < 10 ? "0" + s : s) + "</span>"), t.find(".progress-number").length) {
                            const e = t.find(".progress-number span:first-child")[0],
                                n = t.find(".progress-number span:last-child")[0];
                            e && n && (e.textContent = a < 10 ? "0" + a : a, n.textContent = s < 10 ? "0" + s : s)
                        }
                    }
                }
            },
            d = e.extend({}, c, a),
            u = new Swiper(t.get(0), d);
        t.find(".swiper-slide").each((function () {
            var t = e(this),
                a = t.find("img");
            if (a.length) {
                var s = a.attr("src"),
                    n = t.find(".explore-single-slide, .box-img, .propery-single-slide").get(0);
                if (n) {
    ...
    e(c).on("submit", (function (e) {
        ...
        e(this).each((function () {
            ...
            s = Math.floor(l.height() / 2), n = l.attr(t), i = l.attr(a), o = f(e(i).css("padding-top")), r = f(e(i).css("padding-bottom")), "top-half" === n ? (e(i).css("padding-bottom", r + s + "px"), l.css("margin-top", "-" + s + "px")) : "bottom-half" === n && (e(i).css("padding-top", o + s + "px"), l.css("margin-bottom", "-" + s + "px"))
        }))
    };
    ...
    e.fn.lettering = function (t) {
        return t && g[t] ? g[t].apply(this, [].slice.call(arguments, 1)) : "letters" !== t && t ? (e.error("Method " + t + " does not exist on jQuery.lettering"), this) : g.init.apply(this, [].slice.call(arguments, 0))
