var Swiper = function () {
    ...
    function B(e) {
        ...
        if ("wrapper" === l.touchEventsTarget && ! function (e, t) {
            const s = r();
            let a = t.contains(e);
            return !a && s.HTMLSlotElement && t instanceof HTMLSlotElement && (a = [...t.assignedElements()].includes(e), a || (a = function (e, t) {
                const s = [t];
                for (; s.length > 0;) {
                    const t = s.shift();
                    if (e === t) return !0;
    ...
    function N(e) {
        ...
        if (m > r.longSwipesMs) {
            ...
            !t.navigation || i.target !== t.navigation.nextEl && i.target !== t.navigation.prevEl ? ("next" === t.swipeDirection && t.slideTo(null !== w ? w : g + E), "prev" === t.swipeDirection && t.slideTo(null !== b ? b : g)) : i.target === t.navigation.nextEl ? t.slideTo(g + E) : t.slideTo(g)
        }
    }
    ...
    const W = (e, t) => {
        ...
        r && "string" != typeof r && (s[d]("touchstart", e.onDocumentTouchStart, {
            ...
            passive: !0
        }), (i.preventClicks || i.preventClicksPropagation) && r[d]("click", e.onClick, !0), i.cssMode && n[d]("scroll", e.onScroll), i.updateOnWindowResize ? e[c](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", R, !0) : e[c]("observerUpdate", R, !0), r[d]("load", e.onLoad, {
            capture: !0
        }))
    },
    ...
    const Z = {
        ...
        transition: {
            ...
            transitionStart: function (e, t) {
                ...
                a.cssMode || (a.autoHeight && s.updateAutoHeight(), H({
                    swiper: s,
                    runCallbacks: e,
                    direction: t,
                    step: "Start"
            ...
            transitionEnd: function (e, t) {
                ...
                s.animating = !1, a.cssMode || (s.setTransition(0), H({
                    swiper: s,
                    runCallbacks: e,
                    direction: t,
                    step: "End"
        ...
        events: {
            attachEvents: function () {
                ...
                e.onTouchStart = B.bind(e), e.onTouchMove = Y.bind(e), e.onTouchEnd = N.bind(e), e.onDocumentTouchStart = V.bind(e), t.cssMode && (e.onScroll = _.bind(e)), e.onClick = q.bind(e), e.onLoad = F.bind(e), W(e, "on")
            },
    ...
    function de(e) {
        ...
        if (t.params.virtualTranslate && 0 !== s) {
            let e, s = !1;
            e = i ? a : a.filter(e => {
                const s = e.classList.contains("swiper-slide-transform") ? (e => e.parentElement ? e.parentElement : t.slides.find(t => t.shadowRoot && t.shadowRoot === e.parentNode))(e) : e;
    ...
    const pe = [function (e) {
            ...
            if (v >= t.minTranslate() && (v = t.minTranslate()), v <= t.maxTranslate() && (v = t.maxTranslate()), a = !!t.params.loop || !(v === t.minTranslate() || v === t.maxTranslate()), a && t.params.nested && s.stopPropagation(), t.params.freeMode && t.params.freeMode.enabled) {
                ...
                if (!a) {
                    ...
                    if (n >= t.minTranslate() && (n = t.minTranslate()), n <= t.maxTranslate() && (n = t.maxTranslate()), t.setTransition(0), t.setTranslate(n), t.updateProgress(), t.updateActiveIndex(), t.updateSlidesClasses(), (!o && t.isBeginning || !p && t.isEnd) && t.updateSlidesClasses(), t.params.loop && t.loopFix({
                        ...
                        d || (d = l(() => {
                            !t.destroyed && t.params && (c = e, u.splice(0), t.slideToClosest(t.params.speed, !0, void 0, .5))
                        }, 500))
                    }
        ...
        function c(e) {
            ...
            if (t.params.loop) {
                ...
                const e = (i = t.realIndex, r = a, (r %= n = t.slides.length) == 1 + (i %= n) ? "next" : r === i - 1 ? "previous" : void 0);
        ...
        function P(e) {
            ...
            if (u = !1, m = !1, h.push(e), !(h.length < 2)) {
                if (u = !0, g.scaleStart = S(), !g.slideEl) {
                    ...
                    if (a && (a = a.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]), g.imageEl = a, g.imageWrapEl = a ? E(g.imageEl, "." + s.containerClass)[0] : void 0, !g.imageWrapEl) return void (g.imageEl = void 0);
                    g.maxRatio = T()
                }
                if (g.imageEl) {
                    const [e, t] = function () {
                        ...
                        return [(h[0].pageX + (h[1].pageX - h[0].pageX) / 2 - e.x - n.scrollX) / l, (h[0].pageY + (h[1].pageY - h[0].pageY) / 2 - e.y - n.scrollY) / l]
                    }();
        ...
        function L(e) {
            ...
            i >= 0 && (h[i] = e), h.length < 2 || (m = !0, g.scaleMove = S(), g.imageEl && (a.scale = g.scaleMove / g.scaleStart * l, a.scale > g.maxRatio && (a.scale = g.maxRatio - 1 + (a.scale - g.maxRatio + 1) ** .5), a.scale < s.minRatio && (a.scale = s.minRatio + 1 - (s.minRatio - a.scale + 1) ** .5), g.imageEl.style.transform = `translate3d(0,0,0) scale(${a.scale})`))
        }
        ...
        function I(e) {
            ...
            const s = t.params.zoom,
                a = t.zoom,
                i = h.findIndex(t => t.pointerId === e.pointerId);
            i >= 0 && h.splice(i, 1), u && m && (u = !1, m = !1, g.imageEl && (a.scale = Math.max(Math.min(a.scale, g.maxRatio), s.minRatio), g.imageEl.style.transitionDuration = t.params.speed + "ms", g.imageEl.style.transform = `translate3d(0,0,0) scale(${a.scale})`, l = a.scale, o = !1, a.scale > 1 && g.slideEl ? g.slideEl.classList.add("" + s.zoomedSlideClass) : a.scale <= 1 && g.slideEl && g.slideEl.classList.remove("" + s.zoomedSlideClass), 1 === a.scale && (g.originX = 0, g.originY = 0, g.slideEl = void 0)))
        }
        ...
        function A(e) {
            ...
            v.isMoved || (v.width = g.imageEl.offsetWidth || g.imageEl.clientWidth, v.height = g.imageEl.offsetHeight || g.imageEl.clientHeight, v.startX = d(g.imageWrapEl, "x") || 0, v.startY = d(g.imageWrapEl, "y") || 0, g.slideWidth = g.slideEl.offsetWidth, g.slideHeight = g.slideEl.offsetHeight, g.imageWrapEl.style.transitionDuration = "0ms");
            const i = v.width * a.scale,
                r = v.height * a.scale;
            if (v.minX = Math.min(g.slideWidth / 2 - i / 2, 0), v.maxX = -v.minX, v.minY = Math.min(g.slideHeight / 2 - r / 2, 0), v.maxY = -v.minY, v.touchesCurrent.x = h.length > 0 ? h[0].pageX : e.pageX, v.touchesCurrent.y = h.length > 0 ? h[0].pageY : e.pageY, Math.max(Math.abs(v.touchesCurrent.x - v.touchesStart.x), Math.abs(v.touchesCurrent.y - v.touchesStart.y)) > 5 && (t.allowClick = !1), !v.isMoved && !o) {
                if (t.isHorizontal() && (Math.floor(v.minX) === Math.floor(v.startX) && v.touchesCurrent.x < v.touchesStart.x || Math.floor(v.maxX) === Math.floor(v.startX) && v.touchesCurrent.x > v.touchesStart.x)) return v.isTouched = !1, void z();
                if (!t.isHorizontal() && (Math.floor(v.minY) === Math.floor(v.startY) && v.touchesCurrent.y < v.touchesStart.y || Math.floor(v.maxY) === Math.floor(v.startY) && v.touchesCurrent.y > v.touchesStart.y)) return v.isTouched = !1, void z()
            }
            ...
            v.currentX = v.touchesCurrent.x - v.touchesStart.x + v.startX + n * (v.width - 2 * c), v.currentY = v.touchesCurrent.y - v.touchesStart.y + v.startY + n * (v.height - 2 * p), v.currentX < v.minX && (v.currentX = v.minX + 1 - (v.minX - v.currentX + 1) ** .8), v.currentX > v.maxX && (v.currentX = v.maxX - 1 + (v.currentX - v.maxX + 1) ** .8), v.currentY < v.minY && (v.currentY = v.minY + 1 - (v.minY - v.currentY + 1) ** .8), v.currentY > v.maxY && (v.currentY = v.maxY - 1 + (v.currentY - v.maxY + 1) ** .8), b.prevPositionX || (b.prevPositionX = v.touchesCurrent.x), b.prevPositionY || (b.prevPositionY = v.touchesCurrent.y), b.prevTime || (b.prevTime = Date.now()), b.x = (v.touchesCurrent.x - b.prevPositionX) / (Date.now() - b.prevTime) / 2, b.y = (v.touchesCurrent.y - b.prevPositionY) / (Date.now() - b.prevTime) / 2, Math.abs(v.touchesCurrent.x - b.prevPositionX) < 2 && (b.x = 0), Math.abs(v.touchesCurrent.y - b.prevPositionY) < 2 && (b.y = 0), b.prevPositionX = v.touchesCurrent.x, b.prevPositionY = v.touchesCurrent.y, b.prevTime = Date.now(), g.imageWrapEl.style.transform = `translate3d(${v.currentX}px, ${v.currentY}px,0)`
        }

        function k() {
            const e = t.zoom;
            g.slideEl && t.activeIndex !== t.slides.indexOf(g.slideEl) && (g.imageEl && (g.imageEl.style.transform = "translate3d(0,0,0) scale(1)"), g.imageWrapEl && (g.imageWrapEl.style.transform = "translate3d(0,0,0)"), g.slideEl.classList.remove("" + t.params.zoom.zoomedSlideClass), e.scale = 1, l = 1, g.slideEl = void 0, g.imageEl = void 0, g.imageWrapEl = void 0, g.originX = 0, g.originY = 0)
        }
        ...
        function O(e) {
            ...
            const t = n.getComputedStyle(g.imageWrapEl).transform,
                s = new n.DOMMatrix(t);
            if (!c) return c = !0, p.x = e.clientX, p.y = e.clientY, v.startX = s.e, v.startY = s.f, v.width = g.imageEl.offsetWidth || g.imageEl.clientWidth, v.height = g.imageEl.offsetHeight || g.imageEl.clientHeight, g.slideWidth = g.slideEl.offsetWidth, void (g.slideHeight = g.slideEl.offsetHeight);
            ...
            g.imageWrapEl.style.transitionDuration = "0ms", g.imageWrapEl.style.transform = `translate3d(${b}px, ${y}px, 0)`, p.x = e.clientX, p.y = e.clientY, v.startX = b, v.startY = y
        }
        ...
        function D(e) {
            const s = t.zoom,
                a = t.params.zoom;
            if (!g.slideEl) {
                e && e.target && (g.slideEl = e.target.closest(`.${t.params.slideClass}, swiper-slide`)), g.slideEl || (t.params.virtual && t.params.virtual.enabled && t.virtual ? g.slideEl = f(t.slidesEl, "." + t.params.slideActiveClass)[0] : g.slideEl = t.slides[t.activeIndex]);
                let s = g.slideEl.querySelector("." + a.containerClass);
                s && (s = s.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]), g.imageEl = s, g.imageWrapEl = s ? E(g.imageEl, "." + a.containerClass)[0] : void 0
            }
            if (!g.imageEl || !g.imageWrapEl) return;
            let i, r, o, d, c, p, u, m, h, b, y, x, S, M, C, P, L, I;
            t.params.cssMode && (t.wrapperEl.style.overflow = "hidden", t.wrapperEl.style.touchAction = "none"), g.slideEl.classList.add("" + a.zoomedSlideClass), void 0 === v.touchesStart.x && e ? (i = e.pageX, r = e.pageY) : (i = v.touchesStart.x, r = v.touchesStart.y);
            const z = "number" == typeof e ? e : null;
            1 === l && z && (i = void 0, r = void 0, v.touchesStart.x = void 0, v.touchesStart.y = void 0);
            const A = T();
            s.scale = z || A, l = z || A, !e || 1 === l && z ? (u = 0, m = 0) : (L = g.slideEl.offsetWidth, I = g.slideEl.offsetHeight, o = w(g.slideEl).left + n.scrollX, d = w(g.slideEl).top + n.scrollY, c = o + L / 2 - i, p = d + I / 2 - r, h = g.imageEl.offsetWidth || g.imageEl.clientWidth, b = g.imageEl.offsetHeight || g.imageEl.clientHeight, y = h * s.scale, x = b * s.scale, S = Math.min(L / 2 - y / 2, 0), M = Math.min(I / 2 - x / 2, 0), C = -S, P = -M, u = c * s.scale, m = p * s.scale, u < S && (u = S), u > C && (u = C), m < M && (m = M), m > P && (m = P)), z && 1 === s.scale && (g.originX = 0, g.originY = 0), g.imageWrapEl.style.transitionDuration = "300ms", g.imageWrapEl.style.transform = `translate3d(${u}px, ${m}px,0)`, g.imageEl.style.transitionDuration = "300ms", g.imageEl.style.transform = `translate3d(0,0,0) scale(${s.scale})`
        }
        ...
        function G() {
            const e = t.zoom,
                s = t.params.zoom;
            if (!g.slideEl) {
                t.params.virtual && t.params.virtual.enabled && t.virtual ? g.slideEl = f(t.slidesEl, "." + t.params.slideActiveClass)[0] : g.slideEl = t.slides[t.activeIndex];
                let e = g.slideEl.querySelector("." + s.containerClass);
                e && (e = e.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]), g.imageEl = e, g.imageWrapEl = e ? E(g.imageEl, "." + s.containerClass)[0] : void 0
            }
            g.imageEl && g.imageWrapEl && (t.params.cssMode && (t.wrapperEl.style.overflow = "", t.wrapperEl.style.touchAction = ""), e.scale = 1, l = 1, v.touchesStart.x = void 0, v.touchesStart.y = void 0, g.imageWrapEl.style.transitionDuration = "300ms", g.imageWrapEl.style.transform = "translate3d(0,0,0)", g.imageEl.style.transitionDuration = "300ms", g.imageEl.style.transform = "translate3d(0,0,0) scale(1)", g.slideEl.classList.remove("" + s.zoomedSlideClass), g.slideEl = void 0, g.originX = 0, g.originY = 0, t.params.zoom.panOnMouseMove && (p = {
                x: 0,
                y: 0
        ...
        function X() {
            ...
            t.wrapperEl.addEventListener("pointerdown", P, s), t.wrapperEl.addEventListener("pointermove", L, a), ["pointerup", "pointercancel", "pointerout"].forEach(e => {
        ...
        function B() {
            ...
            t.wrapperEl.removeEventListener("pointerdown", P, s), t.wrapperEl.removeEventListener("pointermove", L, a), ["pointerup", "pointercancel", "pointerout"].forEach(e => {
        ...
        Object.defineProperty(t.zoom, "scale", {
            ...
            t.zoom.enabled && function (e) {
                ...
                s.android && e.cancelable && e.preventDefault(), v.isTouched = !0;
            ...
            t.zoom.enabled && function () {
                ...
                const i = b.x * s,
                    ...
                    n = b.y * a,
                    l = v.currentY + n;
                0 !== b.x && (s = Math.abs((r - v.currentX) / b.x)), 0 !== b.y && (a = Math.abs((l - v.currentY) / b.y));
        ...
        function w(e) {
            ...
            const s = t.params.a11y,
                a = e.target;
            if (!t.pagination || !t.pagination.el || a !== t.pagination.el && !t.pagination.el.contains(e.target) || e.target.matches(te(t.params.pagination.bulletClass))) {
        ...
        i("beforeInit", () => {
            ...
            t.params.a11y.enabled && (() => {
                ...
                const i = t.wrapperEl,
                    r = e.id || i.getAttribute("id") || "swiper-wrapper-" + (void 0 === (n = 16) && (n = 16), "x".repeat(n).replace(/x/g, () => Math.round(16 * Math.random()).toString(16)));
                var n;
                ...
                c = T(c), p = T(p), c && c.forEach(t => x(t, r, e.nextSlideMessage)), p && p.forEach(t => x(t, r, e.prevSlideMessage)), E() && T(t.pagination.el).forEach(e => {
            ...
            t.params.a11y.enabled && function () {
                ...
                b() && t.pagination.bullets.forEach(s => {
                    t.params.pagination.clickable && (c(s), t.params.pagination.renderBullet || (u(s, "button"), h(s, e.paginationBulletMessage.replace(/\{\{index\}\}/, y(s) + 1)))), s.matches(te(t.params.pagination.bulletActiveClass)) ? s.setAttribute("aria-current", "true") : s.removeAttribute("aria-current")
                })
            }()
        }), i("destroy", () => {
            t.params.a11y.enabled && function () {
        ...
        const i = (e, s) => {
            ...
            a || (a = ce("flip", e, t.isHorizontal() ? "left" : "top")), i || (i = ce("flip", e, t.isHorizontal() ? "right" : "bottom")), a && (a.style.opacity = Math.max(-s, 0)), i && (i.style.opacity = Math.max(s, 0))
        };
        le({
            effect: "flip",
            swiper: t,
        ...
        s({
            ...
            setTranslate: () => {
                ...
                for (let e = 0, t = a.length; e < t; e += 1) {
                    ...
                    if (oe(0, t).style.transform = y, t.style.zIndex = 1 - Math.abs(Math.round(u)), r.slideShadows) {
                        let e = n ? t.querySelector(".swiper-slide-shadow-left") : t.querySelector(".swiper-slide-shadow-top"),
                            s = n ? t.querySelector(".swiper-slide-shadow-right") : t.querySelector(".swiper-slide-shadow-bottom");
                        e || (e = ce("coverflow", t, n ? "left" : "top")), s || (s = ce("coverflow", t, n ? "right" : "bottom")), e && (e.style.opacity = u > 0 ? u : 0), s && (s.style.opacity = -u > 0 ? -u : 0)
                    }
                }
            },
            setTransition: e => {
            ...
            setTranslate: () => {
                ...
                for (let o = 0; o < e.length; o += 1) {
                    ...
                    if (i.slideShadows) {
                        ...
                        e || (e = ce("cards", d)), e && (e.style.opacity = Math.min(Math.max((Math.abs(p) - .5) / .5, 0), 1))
                    }
                    d.style.zIndex = -Math.abs(Math.round(c)) + e.length, oe(0, d).style.transform = S
                }
            },
            setTransition: e => {
                const s = t.slides.map(e => h(e));
